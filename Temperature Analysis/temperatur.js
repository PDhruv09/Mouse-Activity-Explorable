document.addEventListener("DOMContentLoaded", function () {
    d3.csv("../assets/data/mouse_data.csv").then(function (data) {
        ...
        let colorScale = d3.scaleOrdinal(["blue", "pink"]).domain(genders);

        let filteredData = data.filter(d => d.Gender === "Male");
        ...
        selectMenu.on("change", function () {
            ...
            let updatedData = data.filter(d => d.Gender === selectedGender);
